...
class BluetoothState_State extends $pb.ProtobufEnum {
  static const BluetoothState_State UNKNOWN =
      BluetoothState_State._(0, 'UNKNOWN');
  static const BluetoothState_State UNAVAILABLE =
      BluetoothState_State._(1, 'UNAVAILABLE');
  static const BluetoothState_State UNAUTHORIZED =
      BluetoothState_State._(2, 'UNAUTHORIZED');
  static const BluetoothState_State TURNING_ON =
      BluetoothState_State._(3, 'TURNING_ON');
  static const BluetoothState_State ON = BluetoothState_State._(4, 'ON');
  static const BluetoothState_State TURNING_OFF =
      BluetoothState_State._(5, 'TURNING_OFF');
...
class BluetoothDevice_Type extends $pb.ProtobufEnum {
  static const BluetoothDevice_Type UNKNOWN =
      BluetoothDevice_Type._(0, 'UNKNOWN');
  static const BluetoothDevice_Type CLASSIC =
      BluetoothDevice_Type._(1, 'CLASSIC');
...
class DeviceStateResponse_BluetoothDeviceState extends $pb.ProtobufEnum {
  static const DeviceStateResponse_BluetoothDeviceState DISCONNECTED =
      DeviceStateResponse_BluetoothDeviceState._(0, 'DISCONNECTED');
  static const DeviceStateResponse_BluetoothDeviceState CONNECTING =
      DeviceStateResponse_BluetoothDeviceState._(1, 'CONNECTING');
  static const DeviceStateResponse_BluetoothDeviceState CONNECTED =
      DeviceStateResponse_BluetoothDeviceState._(2, 'CONNECTED');
  static const DeviceStateResponse_BluetoothDeviceState DISCONNECTING =
      DeviceStateResponse_BluetoothDeviceState._(3, 'DISCONNECTING');
